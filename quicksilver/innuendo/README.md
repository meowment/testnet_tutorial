...
```
wget -O quicksilver.sh https://raw.githubusercontent.com/meowment/testnet_tutorial/main/quicksilver/innuendo/quicksilver.sh && chmod +x quicksilver.sh && ./quicksilver.sh
```
