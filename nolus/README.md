...
curl -o - -L https://snap.nolus-testnet.meowment.xyz/nolus/wasm-nolus.tar.lz4 | lz4 -c -d - | tar -x -C $HOME/.nolus --strip-components 2
curl -o - -L https://snap.nolus-testnet.meowment.xyz/nolus/nolus-snapshot-latest.tar.lz4 | lz4 -c -d - | tar -x -C $HOME/.nolus --strip-components 2
